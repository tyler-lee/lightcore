...
exports.rabbitStream=function(key,iv){ 
var keyHex=CryptoJS.enc.Hex.parse(key); 
var ivHex=CryptoJS.enc.Hex.parse(iv); 
var plain="00000000000000000000000000000000";//128bit
var pHex=CryptoJS.enc.Hex.parse(plain);
var stream=CryptoJS.Rabbit.encrypt(pHex,keyHex,{iv:ivHex});
return stream; 
} 
 
exports.Init=function(key){ 
var rabbit=CryptoJS.algo.Rabbit.createEncryptor(key);
return rabbit;
}
exports.KeyEmpty=function(rabbit,round1){
var pHex={words:[0,0,0,0],sigBytes:16};
 for(var j=0;j<round1;j++)
   rabbit.process(pHex);
}
exports.KeyStream=function(rabbit){
var pHex={words:[0,0,0,0],sigBytes:16};
var pc=rabbit.process(pHex);
return pc;
}
...
exports.RabbitEncryptTest=function(key,ciphertext){
var rabbit=CryptoJS.algo.Rabbit.createEncryptor(key);
var words=rabbit.process(ciphertext);
return words;
}

exports.Finalize=function(rabbit){
return rabbit.finalize();
}
